  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      ...
      <nav>
        <div class="container">
          <ol>
            <li><a href="gestionDesFonds.html">reporter un pret</a></li>
            <li>reporter pret</li>
          </ol>
        </div>
      </nav>
    ...
    <section class="sample-page">
      ...
      <form method='POST'>
        <div><input type='number' id='idmembre' name='idmembre' placeholder="entrer l'identifiant du membre"/></div><br/>
        <div><input type='date' id='delais' name='delais'/></div><br/>
        <div><input type='submit' formaction="GestionDesPrets.php" id='reporter' value="reporter" name='reporter'/></div><br/>
    ...
    <?php
      if(isset($_POST['reporter'])){
       ...
       $envoi=mysqli_query($connect,$req)or die('echec querry'.mysqli_Error());
          echo"date reporter avec success";
      }
